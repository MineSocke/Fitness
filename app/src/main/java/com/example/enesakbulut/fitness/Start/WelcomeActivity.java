...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.activity_first_start4,
                R.layout.activity_first_start5,
                R.layout.activity_first_start6,
        };
    ...
    private void launchHomeScreen() {
        ...
        SharedPreferences settings = getSharedPreferences(WelcomeActivity.PREFS_SETUP, 0); // 0 - for private mode
